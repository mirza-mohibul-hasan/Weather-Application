...
import com.mohibul.projectweather.databinding.ActivityHomeBinding;
import com.google.android.gms.location.FusedLocationProviderClient;
import com.google.android.gms.location.LocationServices;

import org.json.JSONException;
import static com.mohibul.projectweather.CityFinder.getCityNameUsingNetwork;
import static com.mohibul.projectweather.CityFinder.setLongitudeLatitude;
import static com.mohibul.projectweather.NetworkConnection.isInternetConnected;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        int REQUEST_CODE_EXTRA_INPUT = 101;
    ...
    private void setLatitudeLongitudeUsingCity(String cityName) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL.getCity_url(), null, response -> {
            try {
                LocationCooridinate.lat = response.getJSONObject("coord").getString("lat");
                LocationCooridinate.lon = response.getJSONObject("coord").getString("lon");
